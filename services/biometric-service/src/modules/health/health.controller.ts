 ...
 * @description Healthcheck Terminus — Postgres (templates, consentements, audit).
 *
 ...
 * @date        2026
 * @module      biometric-service/modules/health
 */
...
export class HealthController {
  ...
  @Get()
  @HealthCheck()
  @ApiOperation({ summary: 'Healthcheck détaillé (Postgres requis)' })
  check() {
  ...
  live(): { status: 'live'; service: 'biometric-service'; timestamp: string } {
    return {
      status: 'live',
