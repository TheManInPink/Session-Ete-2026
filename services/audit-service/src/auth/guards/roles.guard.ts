 ...
 *              Comparaison INSENSIBLE À LA CASSE (les claims peuvent être
 *              'auditor' ou 'AUDITOR' selon l'émetteur). Si aucun `@Roles()`
 *              n'est posé, l'accès est autorisé. DOIT s'exécuter APRÈS
 *              {@link JwtAuthGuard}. ADR-027 : classe LOCALE.
 *
 * @module      audit-service/auth/guards
 */
