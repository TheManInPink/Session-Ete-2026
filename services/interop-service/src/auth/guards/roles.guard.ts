 ...
 *              Comparaison INSENSIBLE À LA CASSE. Si aucun `@Roles()` n'est posé,
 *              l'accès est autorisé. DOIT s'exécuter APRÈS {@link JwtAuthGuard}.
 *              ADR-027 : classe LOCALE.
 *
 * @module      interop-service/auth/guards
 */
