...
| `ai-models/` (datasets, modèles) | ✅ **Livré (PROMPT 4.3)** — `dataset-generator` (restauré) + `training` (pipeline XGBoost + Isolation Forest, bundle joblib, éval SVG) + intégration `ai-service` ; cf. ADR-030 |
