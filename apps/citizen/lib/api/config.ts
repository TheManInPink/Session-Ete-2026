 ...
 *
 * Refuse de démarrer en production si le mode est `mock` : sinon l'app
 * servirait de fausses identités « valides » — catastrophique pour un système
 * d'identité. Appelé au boot par `instrumentation.ts`.
 *
...
/**
 * URL **publique** du gateway — UNIQUEMENT pour le signalement anonyme SIGAC,
 * appelé en direct depuis le navigateur (cookies omis → anonymat).
 */
