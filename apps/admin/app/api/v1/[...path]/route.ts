 ...
 * @description BFF (Backend-for-Frontend) — proxy d'API **authentifié** de la
 *              console agent.
 *
 ...
 *
 *              Contrairement à citizen, TOUS les appels navigateur de la
 *              console (y compris la file procureur SIGAC) passent par ici :
 *              il n'existe pas de canal anonyme côté agent.
 *
