 ...
 * @description Échange du code OIDC + vérification ID token + pose des cookies
 *              de session côté console agent CTDEC (client `nina-admin`).
 *              Pattern miroir d'`apps/citizen/app/api/auth/callback/route.ts`.
