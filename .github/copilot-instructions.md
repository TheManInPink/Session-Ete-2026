...
4. Read `docs/DOCUMENTATION-MAP.md` for the cross-reference map between 27 docs, 25 ADRs and 6
   governance files (and known drifts).
5. For architecture/codebase questions, read `graphify-out/GRAPH_REPORT.md` if present (check the
   date in header — it may be stale).
