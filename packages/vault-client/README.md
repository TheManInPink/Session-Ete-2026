...
Client TypeScript pour HashiCorp Vault, conçu pour les services
NestJS du Bloc A NINA-AES.
...
- **Helpers métier** : `getSecret`, `getDatabaseCreds`, `transitSign`,
  `transitVerify`, `rotateTransitKey`
